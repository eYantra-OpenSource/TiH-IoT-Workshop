...
#define OTA_SUCCESS_EVENT 100
#define OTA_FAIL_EVENT 101

#define OTA_MODE_SMART	0
#define OTA_MODE_FORCED	1
...
#define EY_OTA_EVENT_SUCCESS			11
#define EY_OTA_EVENT_FAIL				12
